...
import "./App.css";
import { translateText, photoToText, detectLanguage } from "./services/translatation";
...
function App() {
  ...
  const handleSelectChange = async (event) => {
    ...
    let translatation = await translateText(detectedLanguage, desiredLanguage, text);
  ...
  return (
    <div className="App">
      {showOutput ? <Summary setShowOutput={setShowOutput} summarizedText1={summarizedText1} summarizedText2={summarizedText2} /> : <></>}
      ...
      {cameraOpen ? (
        ...
        <div className="camera_button" onClick={() => {
          setCameraOpen(true);
        }}>
      ...
      {textInputOpen ? <textarea value={text} onChange={(e) => setText(e.target.value)} /> : <div className="textinput_button" onClick={() => { setTextInputOpen(true) }}>
